    ...
    <section id="activities" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 animate-fade-in-up">
          ...
          <h3 className="text-4xl font-extrabold text-slate-900 mb-6">Holistic Development</h3>
        ...
        <div className="flex justify-center mb-10 w-full overflow-x-auto pb-4">
          <div className="inline-flex bg-slate-50 rounded-full shadow-sm p-1.5 border border-slate-200">
            <button
        ...
        <div className="relative group">
          ...
          <button 
            onClick={scrollLeft}
            className="absolute left-[-20px] top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-white rounded-full shadow-lg border border-slate-100 flex items-center justify-center text-slate-600 hover:text-green-600 hover:scale-110 transition-all opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0"
          ...
          <button 
            onClick={scrollRight}
            className="absolute right-[-20px] top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-white rounded-full shadow-lg border border-slate-100 flex items-center justify-center text-slate-600 hover:text-green-600 hover:scale-110 transition-all opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0"
            ...
            {activeActivities.map((activity, index) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between relative bg-white">
                  ...
                  <h4 className={`font-bold text-slate-800 text-[14px] leading-snug transition-colors line-clamp-4 ${activeTab === 'sports' ? 'group-hover:text-green-600' : 'group-hover:text-[var(--primary)]'}`}>
                    {activity.name}
                  </h4>
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <button className={`w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0 ${activeTab === 'sports' ? 'text-green-600 hover:bg-green-600 hover:text-white' : 'text-[var(--primary)] hover:bg-[var(--primary)] hover:text-white'}`}>
